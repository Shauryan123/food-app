  ...
  return (
    <div className="w-full flex items-center justify-between gap-3">
      ...
      <div className="flex items-center justify-center gap-4">
        <div className="flex items-center justify-center gap-3 px-3 py-2 bg-white backdrop-blur-md shadow-md rounded-md"><MdSearch className="text-gray-400 text-2xl"/>
        <input
            type="text"
