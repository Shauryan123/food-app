...
const DBNewItem = () => {
  ...
  return (
    <div className="flex flex-col items-center justify-center pt-6 px-24 w-full">
      <div className="border border-gray-300 bg-white rounded-md p-4 w-full flex flex-col items-center justify-center gap-4">
        <InputValueField
          type={"text"}
                    ...
                    <div className=" flex flex-col items-center justify-center h-full w-full cursor-pointer">
                      <div className="flex flex-col justify-center items-center cursor-pointer">
                        <p className="font-bold text-4xl">
                          <FaCloudUploadAlt className="-rotate-0 text-black" />
                        </p>
...
export const InputValueField = ({
  ...
  return (
    <input
      ...
      value={stateValue}
      className="w-full px-4 py-3 bg-white text-black shadow-md outline-none rounded-md border border-gray-200 focus:border-red-400 "
      onChange={(e) => {
