  ...
  return (
    <header className="fixed backdrop-blur-md z-50 inset-x-0 top-0 flex items-center justify-between px-12 md:px-20 py-6">
      <NavLink to={"/"} className="flex items-center justify-center gap-4">
        ...
        <p className="font-semibold text-xl text-textColor">City</p>
      </NavLink>
        ...
        {user ? (
          <>
            <div className="relative cursor-pointer" onMouseEnter={() => {setIsMenu(true)}}>
             ...
             {isMenu &&  <motion.div {...slideTop} className="px-6  w-48 py-4 backdrop-blur-md bg-white rounded-md shadow-md absolute top-12 right-0 flex flex-col gap-4" onMouseLeave={() => setIsMenu(false)} >
