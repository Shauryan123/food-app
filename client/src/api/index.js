...
export const baseURL = "http://localhost:5001/fullstack-food-app-c9c33/us-central1/app";
...
export const addNewItemToCart = async(user_id, data) => {
    try {
        ...
        console.log("ITEM ADDED/MODIFIED ");
...
export const increaseItemQuantity = async(user_id, productId, type) => {
    ...
    try {
        const res = await axios.post(
            ...
            null, { params: { productId: productId, type: type } }
        );
        return res.data.data;
    } catch (error) {
        return null;
